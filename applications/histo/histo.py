...
robin_text = open(
    "/Users/david/Desktop/cs/cs-module-project-hash-tables/applications/histo/robin.txt", "r")
remove_characters = ["\"", ":", ";", ",", ".", "-", "+", "=", "/", "\\",
                     "|", "[", "]", "{", "}", "(", ")", "*", "^", "&", '', "!", "?"]
space = " "
...
alphabetized_word_tally = sorted(
    word_tallies.items(), reverse=True, key=lambda item: item[0])
